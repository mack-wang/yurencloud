//用JavaScript实现经典MVC模式
//http://peter.michaux.ca/maria/
var maria = (function () { // IIFE
    ...
    (function () {
        ...
        evento.EventTarget.prototype.dispatchEvent = function (evt) {
            ...
            if (hasOwnProperty(this, '_evento_parents') && !evt._propagationStopped) {
    ...
    (function () {
        ...
        function bundlesAreEqual(a, b) {
            return (a.element === b.element) &&
                ...
                ((!a.hasOwnProperty('auxArg') && !b.hasOwnProperty('auxArg')) ||
...
// insure prototype object is initialized correctly
    ...
    (function () {
        ...
        hormigas.ObjectSet.prototype.every = function (callbackfn /*, thisArg */) {
            var thisArg = arguments[1];
            for (var p in this._hormigas_ObjectSet_elements) {
                if (Object.prototype.hasOwnProperty.call(this._hormigas_ObjectSet_elements, p) && !callbackfn.call(thisArg, this._hormigas_ObjectSet_elements[p])) {
                    return false;
                }
            }
            return true;
