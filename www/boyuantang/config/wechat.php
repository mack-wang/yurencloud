...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wx33252017a06027b1'),         // AppID
    'secret'  => env('WECHAT_SECRET', '0c1ac6f09fab1e715614d9fc8a148ccf'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', 'boyuantang'),          // Token
    'aes_key' => env('WECHAT_AES_KEY', 'qF2HEa87aNW966ZK840R0ByqtasKJRNyriwbWQsdtlF'),                    // EncodingAESKey
